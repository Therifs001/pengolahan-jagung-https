...
},
{
    ...
    steps: [<ol><li>
        "Persiapkan Kulit Jagung: Pilih kulit jagung yang sudah kering dan cukup lentur. Kulit jagung yang kering lebih mudah dibentuk, tetapi jika terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya. Potong kulit jagung menjadi beberapa bagian dengan ukuran yang bervariasi sesuai dengan bentuk dan ukuran boneka yang diinginkan (misalnya 10-15 cm untuk tubuh, dan 5 cm untuk kepala).",
        "Membentuk Kepala Boneka: Ambil selembar kulit jagung, gulung atau lipat untuk membentuk kepala. Anda bisa menggunakan lebih dari satu lapisan kulit jagung untuk menciptakan bentuk kepala yang lebih padat. Ikat bagian bawah kepala menggunakan benang atau kawat agar bentuk kepala tetap kokoh dan tidak terbuka.",
        "Membuat Badan Boneka: Ambil potongan kulit jagung lainnya dan gulung atau lipat untuk membentuk tubuh. Ukuran tubuh bisa disesuaikan dengan besar kepala boneka. Ikat ujung tubuh dengan benang atau kawat untuk membuat bagian bawah tubuh tetap tertutup.",
        "Menyambungkan Kepala dan Badan: Gabungkan kepala dan tubuh boneka dengan cara menyatukan kedua bagian menggunakan benang atau kawat, pastikan bagian kepala terpasang dengan rapat pada tubuh boneka.",
        "Membuat Tangan dan Kaki Boneka: Ambil beberapa helai kulit jagung yang lebih kecil dan gulung atau lipat untuk membentuk tangan dan kaki. Ikat kedua ujung tangan dan kaki dengan benang untuk memastikan bentuknya stabil. Pasang tangan dan kaki pada tubuh boneka dengan lem atau benang, pastikan bagian tubuh tetap terhubung dengan rapi.",
        "Menambahkan Wajah: Gunakan manik-manik atau kancing untuk membuat mata boneka. Tempelkan manik-manik tersebut pada bagian wajah boneka menggunakan lem. Untuk hidung dan mulut, Anda bisa menggambar atau menggunakan potongan kecil kain atau flanel yang ditempelkan."
    </li></ol>],
    ...
    summary: "Langkah-langkah membuat topi kreatif dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Pilih daun jagung yang sudah kering dan cukup besar. Daun jagung yang kering lebih mudah dibentuk, tetapi jika terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya.",
        "Membuat Bagian Atas Topi: Ambil selembar daun jagung yang besar dan tekuk menjadi bentuk bulat. Pastikan ujung-ujung daun saling bertemu untuk membentuk dasar topi. Ikat bagian ujung dengan benang atau kawat untuk menjaga bentuknya.",
        "Membuat Bagian Pinggir Topi: Ambil daun jagung yang lebih kecil dan rapikan tepinya. Tempelkan daun-daun kecil di sekitar dasar topi untuk membuat bagian pinggir topi lebih lebar dan indah. Gunakan lem atau jahitan untuk menyatukan daun-daun tersebut.",
        "Membuat Tali Topi: Ambil beberapa helai daun jagung kecil dan gulung menjadi tali. Pasang tali pada sisi topi agar topi dapat dikenakan dengan mudah.",
        "Menghias Topi (Opsional): Anda bisa menambahkan aksesori tambahan seperti bunga kering, benang warna-warni, atau manik-manik untuk mempercantik topi daun jagung sesuai selera."
    </li></ol>],
...

{
    ...
    summary: "Langkah-langkah membuat tikar kreatif dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Pilih daun jagung yang sudah kering dan cukup besar. Jika daun jagung terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya.",
        "Memotong Daun Jagung: Potong daun jagung menjadi ukuran yang seragam (misalnya 15-20 cm). Anda akan membutuhkan banyak potongan untuk menyusun tikar.",
        "Menyusun Daun Jagung: Ambil beberapa potongan daun jagung dan susun secara sejajar untuk membentuk lapisan pertama tikar. Pastikan daun-daun tersebut saling berdekatan dan rata.",
        "Mengikat Daun Jagung: Gunakan benang atau kawat untuk mengikat setiap ujung daun jagung yang disusun secara sejajar. Ikat dengan rapat agar daun tetap terjaga posisinya.",
        "Membuat Lapisan Kedua: Setelah lapisan pertama selesai, buat lapisan kedua dengan cara yang sama. Letakkan lapisan kedua di atas lapisan pertama, kemudian ikat kedua lapisan dengan benang atau kawat untuk menyatukan keduanya.",
        "Menambah Ukuran Tikar: Ulangi proses ini hingga ukuran tikar sesuai dengan keinginan. Anda dapat menambahkan beberapa lapisan untuk membuat tikar lebih besar atau lebih tebal.",
        "Menyelesaikan Tikar: Setelah tikar selesai, rapikan ujung-ujungnya agar terlihat rapi. Anda bisa menambahkan hiasan atau aksesoris seperti pita atau bunga kering untuk mempercantik tikar jika diinginkan."
    </li></ol>],
    ...
    summary: "Langkah-langkah membuat bakul kreatif dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Pilih daun jagung yang sudah kering dan cukup lentur. Jika daun jagung terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya.",
        "Memotong Daun Jagung: Potong daun jagung menjadi beberapa bagian dengan ukuran yang seragam, sekitar 10-15 cm. Daun-daun ini akan digunakan untuk anyaman bakul.",
        "Membuat Dasar Bakul: Ambil beberapa helai daun jagung dan susun secara melingkar untuk membentuk dasar bakul. Ikat ujung-ujungnya dengan benang atau kawat untuk menyatukan bagian dasar.",
        "Membuat Dinding Bakul: Setelah dasar selesai, lanjutkan dengan membuat dinding bakul dengan cara melilitkan daun jagung yang sudah dipotong secara vertikal. Anyam daun-daun tersebut secara berputar dan rapatkan setiap lapisan agar dinding bakul kokoh.",
        "Menambahkan Pegangan: Ambil beberapa helai daun jagung yang lebih panjang, lalu anyam menjadi tali untuk pegangan bakul. Pasang pegangan tersebut pada sisi bakul dengan mengikatnya pada bagian atas.",
        "Menyelesaikan Bakul: Setelah dinding bakul dan pegangan terpasang dengan baik, rapikan ujung-ujung bakul dan pastikan setiap bagian terikat dengan kuat agar bakul dapat digunakan dengan aman."
    </li></ol>],
...
},
{
    ...
    summary: "Langkah-langkah membuat tas kreatif dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Pilih daun jagung yang sudah kering dan cukup lentur. Jika daun jagung terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya.",
        "Memotong Daun Jagung: Potong daun jagung menjadi ukuran yang seragam, sekitar 15-20 cm panjangnya. Daun-daun ini akan digunakan untuk anyaman tas.",
        "Membuat Dasar Tas: Ambil beberapa helai daun jagung dan susun secara sejajar untuk membentuk dasar tas. Ikat ujung-ujungnya dengan benang atau kawat untuk menjaga posisi dasar tas tetap kokoh.",
        "Membuat Dinding Tas: Setelah dasar tas selesai, lanjutkan dengan membuat dinding tas menggunakan teknik anyaman. Ambil daun jagung dan anyam secara vertikal dan horizontal untuk membentuk sisi-sisi tas. Pastikan setiap lapisan anyaman rapat agar tas kuat.",
        "Membuat Pegangan Tas: Ambil beberapa helai daun jagung yang lebih panjang dan kuat, lalu anyam menjadi tali yang cukup panjang untuk pegangan tas. Pasang tali tersebut pada bagian atas tas dengan mengikatnya pada sisi-sisi tas.",
        "Menyelesaikan Tas: Setelah bagian dinding dan pegangan tas terpasang dengan baik, rapikan ujung-ujung tas dan pastikan anyaman serta ikatan kuat agar tas bisa digunakan dengan aman dan tahan lama.",
        "Menghias Tas (Opsional): Anda bisa menambahkan hiasan atau aksesoris seperti bunga kering, manik-manik, atau pita untuk mempercantik tampilan tas sesuai selera."
    </li></ol>],
...
},
{
    ...
    summary: "Langkah-langkah membuat bunga kreatif dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Pilih daun jagung yang sudah kering dan cukup lentur. Jika daun jagung terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya.",
        "Memotong Daun Jagung: Potong daun jagung menjadi bagian-bagian kecil yang dapat digunakan untuk membuat kelopak bunga, sekitar 5-10 cm panjangnya, sesuai dengan ukuran bunga yang diinginkan.",
        "Membuat Kelopak Bunga: Ambil selembar daun jagung dan gulung atau lipat untuk membentuk kelopak bunga. Anda bisa menggunakan beberapa lapisan daun jagung untuk menciptakan kelopak yang lebih tebal dan menarik.",
        "Menyusun Kelopak: Gabungkan kelopak-kelopak daun jagung dengan menyusunnya dalam bentuk melingkar. Tempelkan bagian tengah kelopak dengan menggunakan lem atau kawat untuk menyatukan kelopak-kelopak tersebut.",
        "Membuat Tangkai Bunga: Ambil sehelai daun jagung yang lebih panjang dan lentur, kemudian gulung atau anyam untuk membentuk tangkai bunga. Pastikan tangkai cukup panjang dan kuat untuk menopang bunga.",
        "Menyatukan Tangkai dan Bunga: Pasang tangkai pada bagian bawah bunga dengan menggunakan benang, kawat, atau lem untuk memastikan bunga dan tangkai terhubung dengan kuat.",
        "Menyelesaikan Bunga: Setelah bunga dan tangkai terpasang, rapikan bentuk bunga agar terlihat lebih indah. Anda juga bisa menambahkan daun jagung kecil sebagai pelengkap hiasan di sekitar bunga.",
        "Menghias Bunga (Opsional): Untuk mempercantik bunga, Anda bisa menambahkan aksen seperti pita, manik-manik, atau cat untuk memberi warna pada kelopak bunga."
    </li></ol>],
...
},
{
    ...
    summary: "Langkah-langkah membuat dompet kreatif dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Pilih daun jagung yang sudah kering dan cukup lentur. Jika daun jagung terlalu keras, rendam sebentar dalam air hangat untuk melenturkannya.",
        "Memotong Daun Jagung: Potong daun jagung menjadi ukuran yang seragam, sekitar 15-20 cm panjangnya. Daun-daun ini akan digunakan untuk anyaman dompet.",
        "Membuat Bagian Dalam Dompet: Ambil beberapa helai daun jagung dan susun secara sejajar untuk membentuk bagian dalam dompet. Ikat ujung-ujungnya dengan benang atau kawat untuk menjaga posisi bagian dalam tetap kokoh.",
        "Membuat Dinding Dompet: Setelah bagian dalam selesai, lanjutkan dengan membuat dinding dompet dengan cara anyam daun jagung secara vertikal dan horizontal. Pastikan anyaman rapat agar dompet kuat dan aman untuk menyimpan barang.",
        "Menambahkan Penutup Dompet: Ambil beberapa helai daun jagung tambahan dan anyam untuk membuat penutup dompet. Pasang penutup ini dengan mengikat atau menjahitnya pada bagian atas dompet.",
        "Membuat Resleting atau Kancing (Opsional): Jika ingin menambahkan fungsi lebih pada dompet, Anda bisa menambahkan resleting atau kancing sebagai penutup dompet. Pasang resleting atau kancing dengan hati-hati agar dompet mudah digunakan.",
        "Menyelesaikan Dompet: Setelah bagian-bagian dompet terpasang dengan baik, rapikan ujung-ujung dompet dan pastikan anyaman serta ikatan kuat agar dompet dapat digunakan dengan aman."
    </li></ol>],
...
},
{
    ...
    summary: "Langkah-langkah membuat kompos dari daun jagung",
    ...
    steps: [<ol><li>
        "Persiapkan Daun Jagung: Kumpulkan daun jagung yang sudah kering atau daun jagung sisa panen. Pastikan daun jagung bebas dari bahan kimia atau pestisida.",
        "Memotong Daun Jagung: Potong daun jagung menjadi bagian-bagian kecil untuk mempercepat proses penguraian. Anda bisa menggunakan gunting atau pemotong taman untuk memotongnya menjadi ukuran sekitar 5-10 cm.",
        "Membuat Tumpukan Kompos: Pilih tempat yang teduh dan memiliki ventilasi yang baik untuk membuat tumpukan kompos. Tumpuk daun jagung yang sudah dipotong di atas tanah atau di dalam wadah pengomposan.",
        "Menambahkan Bahan Organik Lainnya: Untuk mempercepat proses pengomposan, tambahkan bahan organik lain seperti sisa sayuran, rumput kering, atau sampah organik lainnya. Campurkan daun jagung dengan bahan-bahan tersebut.",
        "Menjaga Kelembaban: Pastikan tumpukan kompos tetap lembab, tetapi tidak terlalu basah. Jika terlalu kering, semprotkan air secukupnya; jika terlalu basah, tambahkan bahan kering seperti jerami atau daun kering.",
        "Aduk Tumpukan Kompos: Secara berkala, aduk tumpukan kompos untuk meningkatkan aliran udara dan mempercepat proses penguraian. Aduk setiap 2-3 minggu sekali.",
        "Memeriksa Kompos: Setelah 2-3 bulan, kompos daun jagung akan terurai menjadi bahan yang gelap dan gembur. Ini adalah tanda bahwa kompos sudah siap digunakan.",
        "Menggunakan Kompos: Setelah kompos selesai, Anda bisa menggunakannya untuk menyuburkan tanah di kebun atau tanaman pot. Kompos akan meningkatkan kualitas tanah dengan menambah bahan organik dan nutrisi penting."
    </li></ol>],
